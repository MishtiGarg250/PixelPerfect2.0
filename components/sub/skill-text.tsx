  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center gap-6">
      ...
      <h1 className="text-3xl md:text-5xl font-bold text-center text-white mb-8">
        Explore the <span className="bg-gradient-to-r from-[#b5b5f6] to-[#f7bff4] text-transparent bg-clip-text">Tech Stack</span> behind{" "}
        <span className="bg-gradient-to-r from-[#b5b5f6] to-[#f7bff4] text-transparent bg-clip-text">Pixel Perfect</span>
      </h1>
    </div>
  );
};
